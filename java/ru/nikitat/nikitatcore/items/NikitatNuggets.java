...
public class NikitatNuggets extends Item implements NikitatItem{

    private String[] names = new String[EnumMetals.maxMeta];

    public NikitatNuggets(){
        this.setHasSubtypes(true);
        this.setCreativeTab(NikitatCoreMod.tabMetals);
        this.setRegistryName("ncnt", "nikitat_nuggets");
        for (EnumMetals em : EnumMetals.values()) {
            names[em.meta] = "nikitat.nugget." + em.name();
        }
    }
    ...
    public void postReg() {
        for (EnumMetals em : EnumMetals.values()) {
            OreDictionary.registerOre("nugget" + em.oreDictName, new ItemStack(this, 1, em.meta));
        }
    }
    ...
    public void setRender() {
        for (EnumMetals em : EnumMetals.values()) {
            ModelLoader.setCustomModelResourceLocation(this, em.meta, new ModelResourceLocation("ncnt:nnugget" + em.meta, "inventory"));
        }
    }
}
